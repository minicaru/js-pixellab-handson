...
console.warn('Ma numesc xxx yyy si stiu html si css.” Foloseste notatia cu paranteze patrate');
...
console.log(
  ...
  console.log(`Numele meu este ${person.name} ${person.surname}, am ${person.age} ani si ${person.friends.length}`);